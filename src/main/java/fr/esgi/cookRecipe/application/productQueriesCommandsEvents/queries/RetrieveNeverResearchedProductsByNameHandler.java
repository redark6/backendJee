...
public class RetrieveNeverResearchedProductsByNameHandler implements QueryHandler<RetrieveNeverResearchedProductsByName, ProductsDTO> {
    ...
    public RetrieveNeverResearchedProductsByNameHandler(LogService logService, ProductApiService productApiService) {
    ...
    public ProductsDTO handle(RetrieveNeverResearchedProductsByName query) {
        ...
        List<ProductLog> productLogs = this.logService.getNeverResearchedProductLogByName(nameFound,pageRequest);
