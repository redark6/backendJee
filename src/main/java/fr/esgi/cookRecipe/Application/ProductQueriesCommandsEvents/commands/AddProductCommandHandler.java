...
public class AddProductCommandHandler implements CommandHandler<AddProduct, Void> {
	...
	@Autowired
	public AddProductCommandHandler(ProductService productService, NutriScoreService nutriScoreService, MeseaureUniteService meseaureUniteService, EventDispatcher eventDispatcher) {
